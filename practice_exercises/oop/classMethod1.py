...
class User:
	...
	def from_string(cls, data_str):
		...
		return cls(first, last, int(age)) #it basically instantiates a class with first last and age just like we would have instantiated like user1 = User("Joe", "Smith", 68)
